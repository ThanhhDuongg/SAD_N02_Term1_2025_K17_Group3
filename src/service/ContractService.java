...
public class ContractService {
    ...
    public boolean addNewContract(Contract contract) {
        ...
        String insertContractQuery = "INSERT INTO contracts (student_id, room_id, start_date, end_date, room_price) VALUES (?, ?, ?, ?, ?)";
        ...
        try {
            ...
            insertStmt.setDouble(5, contract.getroom_price());
            ...
            if (generatedKeys.next()) {
                int newcontract_id = generatedKeys.getInt(1);
                ...
                updateStmt.setInt(1, newcontract_id);
