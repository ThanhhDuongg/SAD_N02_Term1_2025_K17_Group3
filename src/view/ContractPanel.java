...
//        buttonPanel.add(deleteContractButton);
    ...
    public Contract showContractDialog(Contract contract) {
        ...
        if (contract != null) {
            ...
            room_priceField.setText(String.valueOf(contract.getroom_price()));
        }
        ...
        if (result == JOptionPane.OK_OPTION) {
            try {
                ...
                if (contract != null) {
                    newContract.setcontract_id(contract.getcontract_id());
                }
                ...
                newContract.setroom_price(Double.parseDouble(room_priceField.getText()));
                return newContract;
